...
<h1> Image Gallery Design </h1>
	...
	<a data-lightbox="mygallery"><img src="gallery/smallpic5.jpg"></a>
	<a data-lightbox="mygallery"><img src="gallery/smallpic6.jpg"></a>
	<a data-lightbox="mygallery"><img src="gallery/smallpic1.jpg"></a>
	<a data-lightbox="mygallery"><img src="gallery/smallpic2.jpg"></a>
	</div>
	<br/>
	<P align=right>
	<a href = "6Gallery3.jsp">
                    <input type =  "submit" id = "btn" value = "Previous" />  
	<a href = "6Gallery5.jsp">

...
<h1> Image Gallery Design </h1>
	...
	<a href="gallery/pic5.jpg" data-lightbox="mygallery"><img src="gallery/fruit5.jpg"></a>
	<a href="gallery/pic6.jpg" data-lightbox="mygallery"><img src="gallery/fruit6.jpg"></a>
	...
	<br/>
	<P align=right>
	<a href = "6GalleryFruit4.jsp">
                    <input type =  "submit" id = "btn" value = "Previous" />  
	<a href = "6GalleryFruit6.jsp">

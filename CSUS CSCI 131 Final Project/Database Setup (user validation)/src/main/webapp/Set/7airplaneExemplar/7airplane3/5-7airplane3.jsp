...
<body>
	<div class="gallery"> 
	<a data-lightbox="mygallery"><img src="gallery/juice 3.jpg"></a>
	<a data-lightbox="mygallery"><img src="gallery/window3.jpg"></a>
	<a data-lightbox="mygallery"><img src="gallery/shoes3.jpg"></a>
	<a data-lightbox="mygallery"><img src="gallery/bear3.jpg"></a>
	<a data-lightbox="mygallery"><img src="gallery/tomato3.jpg"></a>
	<a data-lightbox="mygallery"><img src="gallery/airplane3.jpg"></a>
	<a data-lightbox="mygallery"><img src="gallery/car3.jpg"></a>
	</div>
	<br/>
	<P align=right>
	<a href = "4-7airplane3.jsp">
                    <input type =  "submit" id = "btn" value = "Previous" />  
	<a href = "6-7airplane3.jsp">

...
<center>
	...
	<a data-lightbox="mygallery"><img src="gallery/bear2.jpg"></a>
	...
	<a data-lightbox="mygallery"><img src="gallery/car2jpg"></a>
	<a data-lightbox="mygallery"><img src="gallery/juice2.jpg"></a>
	</div>
	<center>
	<br/>
	<P align=center>
	<a href = "4-8airplane2.jsp">
                    <input type =  "submit" id = "btn" value = "Previous" />  
	<a href = "6-8airplane2.jsp">

...
public class spriteInfo {
	// Fields
		// TODO: Add private class fields to store x, y (use Vector2D for this) 
		// and tag (String) values given in class constructor
	private Vector2D thisSprite = new Vector2D(0,0);
	private String tag;
	
	// Constructor
	public spriteInfo(Vector2D v2d, String tag){
		// TODO: Save the constructor parameters into class fields
		thisSprite.setX(v2d.getX());
		thisSprite.setY(v2d.getY());
		this.tag = tag;
	}
	...
	public String getTag(){
		// TODO: Remove my placeholder code below (which is there to prevent an error) 
		// and replace it with returning the value of your private field tag
		return tag;
	}
	
	public Vector2D getCoords(){
		// TODO: Remove my placeholder code below (which is there to prevent an error) 
		// and replace it with returning the value of your private field v2d
		return thisSprite;
	}
	...
	public void setCoords(Vector2D newV2D){
		...
		thisSprite.setX(newV2D.getX());
		thisSprite.setY((newV2D).getY());
	}
	...
	public String toString(){
		// TODO: Create a "toString" method to test. Assume an x, y of 100, 50 and a tag of 
		// "star", this should return: [100, 50, star]
		...
		return "[" + thisSprite.getX() + ", " + thisSprite.getY() + ", " + tag + "]";
	}
